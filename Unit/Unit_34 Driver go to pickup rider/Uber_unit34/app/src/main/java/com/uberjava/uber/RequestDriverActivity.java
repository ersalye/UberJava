...
import com.uberjava.uber.Model.TripPlanModel;
                            ...
                            compositeDisposable.add(iGoogleAPI.getDirections("driving",
                                    ...
                                    .subscribe(returnResult -> {
                                        ...
                                        try {
                                            ...
                                            addPickupMarkerWithDruation(duration, origin);
...
//                        Snackbar.make(getView(),e.getMessage(),Snackbar.LENGTH_LONG).show();
    ...
    private void addPickupMarkerWithDruation(String duration, LatLng origin) {
